...
O treinamento é feito usando o dataset público [Celebrity Face Image Dataset](https://www.kaggle.com/datasets/vishesh1412/celebrity-face-image-dataset), baixado automaticamente via `kagglehub`. O projeto é pensado para rodar em máquinas compartilhadas no Google Colab.
...
1. Abra este notebook no [Google Colab](https://colab.research.google.com/).
2. Execute todas as células para:
   - Instalar as dependências;
   - Baixar e preparar o dataset;
   - Treinar o modelo;
   - Testar o reconhecimento em uma imagem do dataset.
3. Faça upload de suas próprias imagens para testar o reconhecimento facial em tempo real.
